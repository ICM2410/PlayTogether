...
import together.devs.playtogether.databinding.ActivityNewEventBinding
...
class NewEventActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.dateShow.setOnClickListener { datePicker() }
        binding.timeShow.setOnClickListener { timePicker() }

        binding.createEvent.setOnClickListener { goToEvents() }
    }
}